...
@freezed
class CommonResponseError<T> with _$CommonResponseError {
  ...
  const factory CommonResponseError.undefinedError(Object? error) = _UndefinedError;
  ...
  T? get safeCustom => this is _CustomError<T> ? (this as _CustomError<T>).error : null;
}
