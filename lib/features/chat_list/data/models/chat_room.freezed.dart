...
abstract class $ChatRoomCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<String> members, Message? lastMessage});
...
class _$ChatRoomImpl implements _ChatRoom {
  const _$ChatRoomImpl({required final List<String> members, this.lastMessage})
      : _members = members;
  ...
  @override
  String toString() {
    return 'ChatRoom(members: $members, lastMessage: $lastMessage)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_members), lastMessage);
...
abstract class _ChatRoom implements ChatRoom {
  const factory _ChatRoom(
      ...
      final Message? lastMessage}) = _$ChatRoomImpl;
