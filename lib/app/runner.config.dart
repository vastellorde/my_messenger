...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i14.RegisterFormBloc>(() => _i14.RegisterFormBloc());
  gh.lazySingleton<_i15.Talker>(() => infrastructureModule.talker());
  gh.singleton<_i16.IAuthService>(
    _i16.AuthService(talker: gh<_i15.Talker>()),
    dispose: _i16.disposeService,
  );
  gh.singleton<_i17.IDioClientCreator>(
      _i17.DioClientCreator(gh<_i15.Talker>()));
